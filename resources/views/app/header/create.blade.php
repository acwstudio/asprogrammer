...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Header Create</div>
                    <div class="card-body">
                        <div class="card-body">
                            <form id="store-header" method="post" action="{{ route('headers.store') }}" role="form"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea id="summernote"
                                                  ...
                                                  placeholder="{{ __('forms.ph.text') }}">{{ old('text') }}</textarea>
...
{{--@section('script')--}}
    {{--@include('app.header.scripts.create')--}}
{{--@endsection--}}