                            ...
                            @foreach($abouts as $about)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="checkbox" value="{{ $about->id }}" class="custom-control-input"
                                               id="checkbox-{{ $about->id }}" {{ $about->active ? 'checked' : '' }}>
                                            <label class="custom-control-label" for="checkbox-{{ $about->id }}"></label>
                                        </div>
                                    </td>
                                    <td>
