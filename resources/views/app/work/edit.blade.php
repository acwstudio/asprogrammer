...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Work Edit</div>
                    <div class="card-body">
                        <div class="card-body">
                            <form id="update-work" method="post" action="{{ route('works.update', $work->id) }}"
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-12">
                                        ...
                                        <input id="form_title" type="text" name="title" value="{{ $work->title }}"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea id="summernote"
                                                  ...
                                                  placeholder="{{ __('forms.ph-post.text') }}">{{ $work->text }}</textarea>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-12">
                                        ...
                                        <input id="form_description" type="text" name="description" value="{{ $work->description }}"
