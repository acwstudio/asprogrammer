                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="custom-control  custom-checkbox">
                                            <input type="checkbox" value="{{ $work->id }}" class="custom-control-input"
                                                   id="checkbox-{{ $work->id }}" {{ $work->active ? 'checked' : '' }}>
                                            <label class="custom-control-label" for="checkbox-{{ $work->id }}"></label>
                                        </div>
                                    </td>
                                    <td>
