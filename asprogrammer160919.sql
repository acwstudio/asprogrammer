...
INSERT INTO `abouts` VALUES (1,'lCddAVCNGs','about_1','jpg',NULL,'2019-09-16 12:28:57'),(3,'jahIKfPVoT','about_3','jpg','2019-08-30 08:32:46','2019-09-16 12:27:18');
...
INSERT INTO `work_translations` VALUES (1,1,'en','Work','<h3>Technology stack</h3><table class=\"table table-bordered\"><tbody><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-774029.jpg\"><br></p></td><td>PHP 7 is a scripting language for developing web applications. Object-Oriented Programming, design patterns.</td></tr><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-945224.png\"><br></p></td><td>Laravel is a modern PHP framework built from components. This approach allows you to add, remove and replace any of its components.</td></tr><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-909283.jpg\"><br></p></td><td>MySQL is a relational database. Creating a database schema, tables and relationships between them, building queries.</td></tr><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-28303.jpg\"><br></p></td><td>Composer is a package manager for dependency management in PHP applications. Installing Laravel, removing and adding components is done using Composer.</td></tr><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-567208.png\"><br></p></td><td>Git is a distributed version control system. It keeps the history of changes made in the process of development and bug fixes.</td></tr><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-803554.jpg\"><br></p></td><td>OS Linux is the most commonly used operating system for servers. An administration by command line interface, deployment and configuration of LAMP and LEMP stacks.</td></tr></tbody></table><h3>Related Technologies</h3><p>My skills in related technologies are sufficient to understand the code of a ready front-end application, modify and supplement it, to use libraries, to understand the structure of the framework.</p><table class=\"table table-bordered\"><tbody><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-374594.jpg\"><br></p></td><td>HTML5 is language for structuring and presenting content</td></tr><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-51539.png\"><br></p></td><td>CSS3 is Cascading Style Sheets. It is formal language for describing the appearence of a page written by HTML.</td></tr><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-501754.png\"><br></p></td><td>Bootstrap is the world\'s most popular front-end library of interface components for creating adaptive, interactive and mobile web applications.</td></tr><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-783603.png\"><br></p></td><td>JavaScript is a programming language for managing the application in a browser on the client side.</td></tr><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-120024.jpg\"><br></p></td><td>jQuery is a JavaScript library aimed at the interaction of JavaScript and HTML. It helps to easily access and manipulate any element, its attributes and contents.</td></tr><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-991289.jpg\"><br></p></td><td>AJAX is a technology accessing the server without reloading the page. The jQuery library provides a very convenient API for working with this technology.</td></tr><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-849286.jpg\"><br></p></td><td>Now there is a rapid growth of front-end technologies and almost every day araise the new JavaScript frameworks. Laravel almost always works in conjunction with them and can\'t be outside this trend. Laravel offers the <b>Laravel Mix</b> a special wrapper to cimplify working with front-end tools. So the developer gets everything necessary to work with modern technologies, including the Vue.js framework.</td></tr></tbody></table><p>If you are interested to hire me to work or want to ask me additional information, please use the feedback form for the first contact. I will be glad to answer you.</p>','Feedback form <a href=\"/en#contact\" target=\"_blank\">Contacts</a>',NULL,NULL),(2,1,'ru','Работа','<h3>Стек технологий</h3><table class=\"table table-bordered\"><tbody><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-932195.jpg\"><br></p></td><td>PHP 7 Скриптовый язык для разработки web приложений. Объектно-ориентированное программирование, паттерны проектирования.</td></tr><tr><td><img src=\"http://test.ru/dim/images/summernote/summernote-941725.png\"></td><td>Laravel современный PHP фреймворк, собранный из компонентов. Этот подход позволяет добавлять, удалять и заменять любой из его компонентов.</td></tr><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-692706.jpg\"><br></p></td><td>MySQL реляционная база данных. Создание схемы базы данных, таблиц и отношений между ними, построение запросов.</td></tr><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-282696.jpg\"><br></p></td><td>Composer пакетный менеджер для управления зависимостями в PHP приложениях. Установка Laravel, удаление и добавление компонентов производится с помощью Composer.</td></tr><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-76458.png\"><br></p></td><td>Git распределенная система управления версиями. Хранит всю историю изменений сделанных в процессе разработки и исправления багов.</td></tr><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-225311.jpg\"><br></p></td><td>OS Linux Наиболее часто применяемая для серверов операционная система. Имею навыки администрирования посредством командной строки, развертывание и настройка LAMP и LEMP стеков, деплой.</td></tr></tbody></table><h3>Смежные технологии</h3><p>Мои навыки в смежных технологиях достаточны, чтобы разбираться в коде готового фронтенд приложения, дорабатывать и дополнять его, пользоваться библиотеками, понимать устройство фреймворка.&nbsp;</p><table class=\"table table-bordered\"><tbody><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-198731.jpg\"><br></p></td><td>HTML5 язык для структурирования и представления контента.&nbsp;</td></tr><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-254308.png\"><br></p></td><td>CSS3 Каскадные таблицы стилей. Формальный язык описания внешнего вида страницы, написанной с помощью языка HTML</td></tr><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-621474.png\"><br></p></td><td>Bootstrap самая популярная в мире фронтенд библиотека компонентов интерфейса для создания адаптивных, интерактивных и мобильных web приложений</td></tr><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-227883.png\"><br></p></td><td>JavaScript язык программирования для управления работой приложения в браузере на стороне клиента.</td></tr><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-464261.jpg\"><br></p></td><td>jQuery библиотека JavaScript, направленная на взаимодействие JavaScript и HTML. Помогает легко получить доступ к любому элементу, к его атрибутам и содержимому, манипулировать ими.</td></tr><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-242292.jpg\"><br></p></td><td>AJAX технология обращения к серверу без перезагрузки страницы. Библиотека jQuery предоставляет очень удобный API для работы с этой технологией.</td></tr><tr><td><p><img src=\"http://test.ru/dim/images/summernote/summernote-201164.jpg\"><br></p></td><td><p>В настоящее время идет бурный рост технологий в области фронтенда и чуть ли не каждый день появляются новые версии JavaScript фреймворков. Laravel почти всегда работает в связке с фронтендом и не может находится вне этого тренда. Laravel предлагает <b>Laravel Mix</b> специальную обертку для упрощения работы с инструментами фронтенда с помощью которой разработчик получает все необходимое для работы с современными технологиями, в том числе и с фреймворком Vue.js</p></td></tr></tbody></table><p><span style=\"font-size: 0.9rem;\">Если вы заинтересованы в сотрудничестве или хотите получить дополнительную информацию, используйте, пожалуйста,&nbsp; для первого контакта форму обратной связи. Буду рад ответить на все ваши вопросы.</span><br></p>','Форма обратной связи <a href=\"/ru#contact\" target=\"_blank\">Контакты</a>',NULL,NULL),(3,2,'ru','ccccc','<p>ccccc</p>','xxxxxx',NULL,NULL),(4,3,'ru','aaaaaaa','<p>aaaaaaaaa</p>','aaaaaaa',NULL,NULL);
...
INSERT INTO `works` VALUES (1,'M3jTNquhDw','work_1','jpg',NULL,'2019-09-15 08:08:58');
...
-- Dump completed on 2019-09-16 18:44:51
