...
INSERT INTO `intros` VALUES (1,'KWUYWQ1C2j','intro_1','jpg',NULL,'2019-09-13 15:19:27'),(2,'LqpN0cij8i','intro_2','jpg','2019-09-13 03:25:00','2019-09-13 14:41:50');
...
INSERT INTO `work_translations` VALUES (1,1,'en','Work','You have to write somrthing awesome here','Test description',NULL,NULL),(2,1,'ru','Работа','<h3>Стек технологий</h3><p><b>Laravel</b>&nbsp; современный PHP фреймворк, собранный из компонентов. Компонентный подход позволяет добавлять, удалять, заменять любой из его компонентов. Например, микрофреймворк Lumen, является облегченной версией Laravel и в нем удалены компоненты, связанные с View (HTML шаблоны) и заменен компонент&nbsp; роутинга на более быстрый.</p><p><b>Composer</b>&nbsp; пакетный менеджер для управления зависимостями в PHP приложениях. Установка Laravel, удаление и установка компонентов производится с помощью Composer</p><p><b>MySQL</b>&nbsp; реляционная база данных. Создание схемы базы данных, таблиц и отношений, построение запросов.</p><p><b>Git</b>&nbsp; распределенная система управления версиями. Хранит все изменения сделанные в процессе разработки и исправления багов.</p><p><b>OS Linux</b>&nbsp; Базовое администрирование, командная строка, развертывание и настройка LAMP и LEMP стеков. Развертывание локальной среды разработки и удаленного сервера, деплой готового приложения с локального сервера на удаленный.</p><h3>Смежные технологии</h3><p><b>HTML5</b>&nbsp; язык разметки web страницы. Работа с HTML кодом не вызывает особых затруднений, учитывая то обстоятельство, что PHP разработчику не требуется писать HTML страницы с нуля.</p><p><b>CSS3</b>&nbsp; таблицы стилей, так же не вызывают затруднений, по той же причине, что и HTML</p><p><b>JavaScript</b>&nbsp; язык программирования для управления работой приложения в браузере на клиентской стороне. Имею базовые навыки, достаточные для конфигурирования js плагинов, написания небольших сниппетов.</p><p><b>jQuery</b>&nbsp; библиотека JavaScript, направленная на взаимодействие JavaScript и HTML. Помогает легко получить доступ к любому элементу, получать доступ к атрибутам и содержимому, манипулировать ими. Умею пользоваться.&nbsp;</p><p><b>AJAX</b>&nbsp; технология обращения к серверу без перезагрузки страницы. Библиотека jQuery предоставляет очень удобный API для работы с этой технологией, не раз ею пользовался.</p><p>В настоящее время идет бурный рост технологий в области фронтенда и чуть ли не каждый день появляются новые JavaScript фреймворки. Поскольку Laravel работает с связке с фронтендом и старается находиться в тренде всего нового, то внутри него предусмотрена специально написанная обертка <b>Laravel Mix</b>, которая упрощает работу с современными инструментами фронтенда. В результате мы получаем готовую среду для разработки фронтенда с помощью фреймворка <b>Vue.js</b>. Я могу разобраться в коде, написанном на Vue.js, но не обладаю достаточными навыками для написания целого приложения на этом фреймворке.</p>','Форма обратной связи <a href=\"http://test.ru/ru#contact\" target=\"_blank\">Контакты</a>',NULL,NULL);
...
INSERT INTO `works` VALUES (1,'LI4I64lNGW','work_1','jpg',NULL,'2019-09-13 17:10:37');
...
-- Dump completed on 2019-09-13 23:21:46
